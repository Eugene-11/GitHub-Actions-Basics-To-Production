...
> **Important:** GitHub Actions scheduled workflows operate using a **best-effort scheduling model** on shared multi-tenant infrastructure and may therefore experience scheduling delays or fail to execute exactly at the configured time during periods of high platform load.
